...
# Function to initialize the Google Vision API client
def initialize_vision_client():
    credentials = service_account.Credentials.from_service_account_file(
        r'C:/Users/loubna/Desktop/app_finale/app_finale/poised-tenure-428115-s9-2948be56ea26.json',
...
def email_generator():
   ...
   # st.set_page_config(page_title="Generate Emails",
    ...
    st.markdown("""
        ...
        Bienvenue dans le Générateur d'Emails de Forge de Bazas. Cet outil vous aide à créer des emails professionnels en toute simplicité. Remplissez les détails ci-dessous et cliquez sur "Générer" pour commencer.
        </p>
